...
const deleteBlog = asyncHandler(async (req, res) => {
    console.log("Delete Blog Controller: Deleting blog with ID", req.params.id);
    ...
    if (blog.author.toString() !== req.user._id.toString()) {
        console.error("Error: Unauthorized to delete this blog");
        throw new ApiError(403, "You are not authorized to delete this blog");
    }

    console.log("Blog found, deleting...");
    await blog.remove();
